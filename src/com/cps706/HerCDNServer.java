...
public class HerCDNServer implements Runnable
{
	...
	public void run() 
	{
		try
		{
			ServerSocket serverSocket = new ServerSocket(MainConfiguration.herCDNServerPort());
	...
	{
		HerCDNServer webServer = new HerCDNServer(MainConfiguration.herCDNServerPort());
		webServer.run();
	}
